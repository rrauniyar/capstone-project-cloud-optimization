...
import com.capstone.beginsetup.model.EC2InstanceInfoFive;
...
public class EC2ControllerCPUFive {
    ...
    public ResponseEntity<?> getAllEC2InstanceInfo() {
        try {
            ...
            List<EC2InstanceInfoFive> instanceInfoList = new ArrayList<>();
            ...
            for (Reservation reservation : reservations) {
                ...
                for (Instance instance : instances) {
                    ...
                    double memoryInGib = getInstanceMemoryInGiB(instanceType, ec2Client);
                    double averageCpuUtilization = getAverageCpuUtilization(instanceId, 5, cloudWatchClient);
                    double totalCostForFiveDays = getTotalCostForFiveDays(instanceType, 0);
                    String formattedAverageCpuUtilization = decimalFormat.format(averageCpuUtilization);
                    String formattedTotalCostForFiveDays = decimalFormat.format(totalCostForFiveDays);
                    EC2InstanceInfoFive instanceInfo = new EC2InstanceInfoFive(
                            instanceType,
                            instanceName,
                            ...
                            Double.parseDouble(formattedTotalCostForFiveDays));
    ...
    private double getInstanceMemoryInGiB(String instanceType,AmazonEC2 ec2Client) {
    ...
    private double getAverageCpuUtilization(String instanceId, int days, AmazonCloudWatch cloudWatchClient) {
        GetMetricStatisticsRequest request = new GetMetricStatisticsRequest()
            ...
            .withPeriod(300) // 5-minute interval
    ...
    private double getTotalCostForFiveDays(String instanceType,int days) {
